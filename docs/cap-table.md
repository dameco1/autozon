...
This document outlines autozon's current ownership structure, planned equity allocation, and dilution scenarios across funding rounds. The cap table is designed to maintain strong founder control while providing meaningful upside for early investors and key hires.
...
| Company | Stage | Valuation | Year | Notes |
|---|---|---|---|---|
...
| Recipient | Allocation | Vesting Start | Notes |
|---|---|---|---|
| **First hire (Growth Manager)** | 1.0–1.5% | Y1 Q3 | Key to Austria growth |
...
|---|---|
| **Operating budget < €50K** | CEO alone |
| **Operating budget > €50K** | Board approval |
| **New funding round** | Board + 66% shareholder vote |
| **Exit / acquisition** | 75% shareholder vote |
| **ESOP grants** | Board approval |
| **Hiring (salary > €80K)** | Board notification |
| **Pivot / major strategy change** | Board discussion + CEO decision |
...
*Document status: V1 — For investor data room. Cap table will be updated in real-time as funding discussions progress. All figures are indicative and subject to final term sheet negotiation.*