...
|---|---|
| 1,500 (–50%) | –50% listing revenue |
| 2,250 (–25%) | –25% listing revenue |
| **3,000 (base)** | **Baseline** |
| 4,000 (+33%) | +33% listing revenue |
| 5,000 (+67%) | +67% listing revenue |
...
|---|---|---|
| Low Premium uptake | Revenue below projections | Strong value differentiation; A/B test pricing; default to Premium in UX |
...
| Delayed Full Service launch | Missing V2 revenue | Core listing fee revenue is self-sustaining; Full Service is additive |
...
| Higher-than-projected AWS costs | Margin pressure at scale | Reserved instances, Savings Plans, right-sizing |
