    ...
    <section className="py-14 sm:py-18 bg-secondary relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <motion.div className="mb-10" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-black text-foreground leading-[0.95]">
            {t.problem.title}
            <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {t.problem.stats.map((stat, i) => (
            <motion.div
              key={i}
              className="group relative bg-muted border border-border rounded-2xl p-10 overflow-hidden hover:border-destructive/30 transition-all duration-500"
