...
const SolutionSection: React.FC = () => {
  ...
  return (
    <section className="py-14 sm:py-18 bg-muted relative">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_50%_100%,hsl(24_85%_48%/0.04),transparent)]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          {t.solution.features.map((feature, i) => {
            ...
            return (
              <motion.div
                key={i}
                className={`group bg-card border border-border rounded-2xl p-8 hover:border-primary/30 transition-all duration-500 relative overflow-hidden ${
