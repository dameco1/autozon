...
const TrustSection: React.FC = () => {
  ...
  return (
    <section id="why-autozon" className="py-14 sm:py-18 bg-muted">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {t.trust.pillars.map((pillar, i) => (
            <motion.div
              key={i}
              className="group bg-card border border-border rounded-2xl p-6 hover:border-primary/20 transition-all duration-500 relative overflow-hidden"
