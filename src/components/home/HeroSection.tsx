    ...
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="relative z-10 pt-24 pb-10" style={{ minHeight: "55vh" }}>
        ...
        <motion.img
          src={heroSellerMale}
          alt=""
          className="hidden xl:block absolute -bottom-4 right-[62%] h-[58vh] w-auto object-contain object-bottom z-[1] pointer-events-none"
        ...
        <motion.img
          src={heroBuyerFemale}
          alt=""
          className="hidden xl:block absolute -bottom-4 left-[62%] h-[55vh] w-auto object-contain object-bottom z-[1] pointer-events-none"
          width={640} height={1280}
          initial={{ opacity: 0, x: 30 }}
          animate={{ opacity: 0.85, x: 0 }}
          transition={{ duration: 0.9, ease: "easeOut" }}
