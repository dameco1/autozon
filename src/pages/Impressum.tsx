  ...
  return (
    <div className="min-h-screen bg-background text-muted-foreground">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        ...
        <h1 className="text-4xl font-display font-black text-foreground mb-8">Impressum / Legal Disclosure</h1>
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-muted-foreground">
          <section>
            ...
            <p className="text-xs text-muted-foreground mt-1">Note: autozon GmbH is not yet registered. Incorporation is planned upon securing seed funding.</p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">Responsible for Website Content</h2>
            <p>Emina Mukic-Buljubasic, Geschäftsführerin</p>
          </section>

          <section>
            <h2 className="text-xl font-display font-bold text-foreground">EU Online Dispute Resolution Platform</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">Disclaimer</h2>

            <h3 className="text-lg font-display font-bold text-foreground mt-4">Liability for Content</h3>
            ...
            <h3 className="text-lg font-display font-bold text-foreground mt-4">Liability for Links</h3>
            ...
            <h3 className="text-lg font-display font-bold text-foreground mt-4">Copyright</h3>
