      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <h1 className="text-3xl font-display font-bold text-white">{t.mfa.setupTitle}</h1>
          </div>
        ...
        <div className="bg-secondary/50 border border-border rounded-2xl p-8 space-y-6">
          ...
          <div className="space-y-2">
            <p className="text-xs text-silver/50">{t.mfa.manualEntry}</p>
            <code className="block bg-charcoal border border-border rounded-lg p-3 text-xs text-primary break-all font-mono">
              {secret}
            </code>
          </div>
          ...
          <form onSubmit={handleVerify} className="space-y-4">
            <div className="space-y-2">
              <Label className="text-silver/80">{t.mfa.step2}</Label>
              <Input
                type="text"
                inputMode="numeric"
                maxLength={6}
