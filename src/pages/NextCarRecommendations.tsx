...
const NextCarRecommendations: React.FC = () => {
  ...
  const scoreBadgeColor = (score: number) => {
    ...
    return "bg-muted border-border text-silver/60";
  };
    ...
    <div className="min-h-screen bg-charcoal text-silver">
      ...
      <div className="max-w-6xl mx-auto px-4 pt-24 pb-16">
        <motion.div className="text-center mb-12" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="text-4xl sm:text-5xl font-display font-black text-white">{t.nextCar.title}</h1>
          <p className="text-silver/60 mt-2">{t.nextCar.subtitle}</p>
        </motion.div>

        {cars.length === 0 ? (
          <div className="text-center py-20 text-silver/40">{t.nextCar.noResults}</div>
        ) : (
              ...
              >
                ...
                <div className="h-32 bg-gradient-to-br from-secondary to-charcoal flex items-center justify-center">
                  <div className="text-center">
                    <span className="text-4xl font-display font-black text-white/10">{car.make}</span>
                  </div>
                </div>
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <h3 className="font-display font-bold text-white text-lg">{car.make} {car.model}</h3>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs text-silver/50 mb-4">
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      <div className="text-xs text-silver/40">{t.nextCar.fairValue}</div>
