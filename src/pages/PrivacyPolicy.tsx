      ...
      <div className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-silver/80">
          ...
          <section>
            ...
            <h3 className="text-lg font-display font-bold text-white mt-6">1. Website Access & Server Logs</h3>
            ...
            <h3 className="text-lg font-display font-bold text-white mt-6">2. User Account Registration</h3>
            ...
            <h3 className="text-lg font-display font-bold text-white mt-6">3. Vehicle Data Collection & Processing</h3>
            <div className="bg-charcoal/50 border border-border rounded-xl p-4 my-3">
              <p className="text-white font-semibold mb-2">⚠️ Important: Car Data We Collect</p>
            ...
            <h3 className="text-lg font-display font-bold text-white mt-6">4. Buyer Preference Data</h3>
            ...
            <h3 className="text-lg font-display font-bold text-white mt-6">5. AI-Powered Image Analysis</h3>
            ...
            <h3 className="text-lg font-display font-bold text-white mt-6">6. Communication Data</h3>
            ...
            <h3 className="text-lg font-display font-bold text-white mt-6">7. Payment & Transaction Data</h3>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-white">Cookies & Tracking</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-white">Data Security</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-white">International Data Transfers</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-white">Data Retention Summary</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-2 pr-4 text-white font-semibold">Data Category</th>
                    <th className="text-left py-2 text-white font-semibold">Retention Period</th>
                  </tr>
                </thead>
                <tbody className="text-silver/60">
