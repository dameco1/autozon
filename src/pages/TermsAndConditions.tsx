  ...
  return (
    <div className="min-h-screen bg-background text-muted-foreground">
      <SEO 
        ...
        description="Read Autozon's complete terms and conditions for using our car trading platform, including user agreements, liability disclaimers, and service policies."
        path="/terms"
      />
      <div className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        ...
        <h1 className="text-4xl font-display font-black text-foreground mb-2">Terms & Conditions</h1>
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-muted-foreground">
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">1. Scope of Application</h2>
            <p>These Terms and Conditions ("Terms") govern the use of the Autozon website and platform (the "Service") operated by autozon GmbH (in Gründung) ("we", "us", or "our"), planned for registration in Vienna, Austria. By accessing or using our Service, you agree to be bound by these Terms and our <Link to="/privacy-policy" className="text-primary hover:underline">Privacy Policy</Link>.</p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">4. Vehicle Data & Listings</h2>
            <div className="bg-muted border border-border rounded-xl p-4 my-3">
              <p className="text-foreground font-semibold mb-2">Important: Your Responsibilities as a Seller</p>
            </div>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">5. Valuations & Fair-Value Pricing</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">6. AI-Powered Features</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">7. Buyer Matching & Recommendations</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">8. Transactions & Payments</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">9. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">10. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">11. Data Protection & Privacy</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">12. Third-Party Links & Services</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">13. Prohibited Uses</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">14. Governing Law & Dispute Resolution</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">15. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-foreground">16. Contact</h2>
