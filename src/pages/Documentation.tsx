...
const sections: Section[] = [
  {
    ...
    docs: [
      ...
      { title: "Corporate Structure", desc: "New Vienna GmbH — Austrian incorporation for market launch", icon: Landmark, file: "corporate-structure.md", status: "ready" },
      { title: "Team & Advisors", desc: "Key hires, advisory board, org chart", icon: Users, file: "team-advisors.md", status: "ready" },
  ...
  },
  {
    ...
    docs: [
      ...
      { title: "Financial Projections", desc: "3-year P&L, cash flow, and growth scenarios", icon: BarChart3, file: "financial-projections.md", status: "ready" },
      { title: "KPI Dashboard", desc: "Key metrics: GMV, take rate, CAC, LTV, conversion rates", icon: BarChart3, file: "kpi-dashboard.md", status: "ready" },
      { title: "Use of Funds", desc: "Allocation plan for current funding round", icon: Landmark, file: "use-of-funds.md", status: "ready" },
      { title: "Cap Table", desc: "Current ownership structure and equity distribution", icon: Users, file: "cap-table.md", status: "ready" },
    ],
  },
  {
    id: "legal",
